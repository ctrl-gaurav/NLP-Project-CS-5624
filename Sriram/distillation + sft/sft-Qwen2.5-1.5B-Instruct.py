...
"""
Qwen 1.5B Fine-tuning Script for Prompt-Response Dataset
...
class FinetuningConfig:
    ...
    # Fine tuning the Qwen2.5-1.5B-Instruct model on a prompt-response dataset.
    ...
    output_dir: str = field(
        default="./finetuned-Qwen2.5-1.5B-Instruct",
    ...
    def __post_init__(self):
        ...
        if self.wandb_run_name is None:
            ...
            self.wandb_run_name = f"qwen1.5b_finetune_{timestamp}"
...
def format_prompt(prompt, tokenizer):
    """Format the prompt for Qwen 2.5 model"""
