...
def main():
    ...
    input_files = [
        '/home/sriramsrinivasan/gemini_data/unique_prompts/unique_prompts_gemini_1.5_flash_8b.json',
    ]
    
    # Output file
    output_file = '/home/sriramsrinivasan/gemini_data/unique_prompts/unique_responses_gemini_1.5_flash_8b.json'
