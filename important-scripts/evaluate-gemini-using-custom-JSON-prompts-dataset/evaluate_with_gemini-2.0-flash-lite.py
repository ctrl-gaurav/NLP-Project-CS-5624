...
API_KEY1 = "AIzaSyC-D1orWM-9cwhJchIB8BOtKjcD6Z7su_M"
API_KEY2 = "AIzaSyA_-D09Cb4SUjKR4sc0gzJxFVUEd2lsdnU"
...
def get_gemini_response(prompt, api_key):
    ...
    try:
        # Generate response using gemini-2.0-flash-lite model
...
def main():
    ...
    input_files = [
        '/home/sriramsrinivasan/gemini_data/unique_prompts/unique_prompts_gemini_2.0_flash_lite.json',
    ]
    
    # Output file
    output_file = '/home/sriramsrinivasan/gemini_data/unique_prompts/unique_responses_gemini_2.0_flash_lite.json'
