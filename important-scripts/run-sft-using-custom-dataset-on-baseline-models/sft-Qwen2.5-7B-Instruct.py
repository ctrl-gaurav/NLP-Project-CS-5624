...
"""
Qwen 7B Fine-tuning Script for Prompt-Response Dataset
...
class FinetuningConfig:
    ...
    # Fine tuning the Qwen2.5-7B-Instruct model on a prompt-response dataset.
    ...
    output_dir: str = field(
        default="./finetuned-Qwen2.5-7B-Instruct",
    ...
    def __post_init__(self):
        ...
        if self.wandb_run_name is None:
            ...
            self.wandb_run_name = f"qwen7b_finetune_{timestamp}"
